                ...
                <div class="flex items-center space-x-4">
                    <div class="relative group">
                        ...
                        <div id="profileMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block z-50">
                            ...
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-purple-100">Pengaturan</a>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                ...
                <!-- Perkembangan Ternak -->
                <a href="{{route('petani-laporan')}}" class="block bg-white rounded-lg shadow hover:shadow-lg transition duration-200 border-l-4 border-green-500">
                    <div class="p-5">
                        <div class="flex justify-between items-start">
                            <div>
                ...
                <a href="" class="block bg-white rounded-lg shadow hover:shadow-lg transition duration-200 border-l-4 border-indigo-500">
                    <div class="p-5">
                        <div class="flex justify-between items-start">
                            <div>
                                <h3 class="text-gray-500 font-medium">Perkiraan Pengembalian</h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('petani.detail', $ternak->id) }}" class="text-blue-600 hover:text-blue-900">Lihat</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
